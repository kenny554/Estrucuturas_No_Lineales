...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // // Realizar recorrido en profundidad (DFS) desde el nodo 1
        // System.out.print("\nRecorrido en profundidad (DFS) desde el nodo 1: ");
        // grafo.getDFS(node1);

        // // // Realizar recorrido en amplitud (BFS) desde el nodo 1
        // // System.out.print("\nRecorrido en amplitud (BFS) desde el nodo 1: ");
        // // grafo.getBFS(node1);
        runSets();
    }
